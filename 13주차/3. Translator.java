...
public class Translator extends JFrame{
	...
	private void addData() { //Data 필드에 값을 넣는 작업
		...
		Data.add(new Word("마크\n기념하다\n표시\n기록\n흔적\n","mark"));
		Data.add(new Word("만들다\n하게하다\n돈을벌다\n소리를내다\n이루다\n","make"));
		Data.add(new Word("남자\n사람\n","man"));
		Data.add(new Word("것이다\n수도있다\n지도모른다\n월\n아마도\n","may"));
		Data.add(new Word("의미하다\n뜻\n수단\n평균\n진심으로\n","mean"));
		Data.add(new Word("놓치다\n그리워하다\n미스\n실종되다\n빼먹다\n","miss"));
		Data.add(new Word("움직이다\n이동하다\n옮기다\n이사하다\n조치\n","move"));
		Data.add(new Word("훨씬\n많은\n매우\n크게\n대부분\n","much"));
		Data.add(new Word("일것이다\n반드시하다\n임에틀림없다\n해야하다\n필요한\n","must"));
		Data.add(new Word("마음\n생각\n반대하다\n정신\n명심하다\n","mind"));
		Data.add(new Word("수\n다수\n번호\n을세다\n","number"));
		Data.add(new Word("지적하다\n메모\n노트\n적어두다\n지폐\n","note"));
		Data.add(new Word("없다\n아니다\n하지말다\n반대\n부인하다\n","no"));
		Data.add(new Word("코\n후각\n","nose"));
		Data.add(new Word("근처\n가깝게\n인접한\n거의\n접근한\n","near"));
		Data.add(new Word("알아차리다\n주목하다\n공지\n게시\n경고\n","notice"));
		Data.add(new Word("부정의\n음성의\n마이너스의\n네거티브\n반대의\n","negative"));
		Data.add(new Word("멋진\n좋은\n훌륭한\n친절한\n반가운\n","nice"));
		Data.add(new Word("않다\n아니다\n없다\n","not"));
		Data.add(new Word("자연\n본성\n성격\n특성\n네이처\n","nature"));
		Data.add(new Word("위에\n계속하여\n에\n의표면에\n","on"));
		Data.add(new Word("열다\n개방하다\n오픈\n공개하다\n시작하다\n","open"));
		Data.add(new Word("없어져\n떨어져\n쉬어\n벗어나\n떠나다\n","off"));
		Data.add(new Word("이상\n끝나서\n위의\n너무\n","over"));
		Data.add(new Word("나가다\n밖에\n나오다\n지금까지\n벗어나서\n","out"));
		Data.add(new Word("한번\n하나\n어느\n한개\n유일한\n","one"));
		Data.add(new Word("의\n으로부터\n을\n","of"));
		Data.add(new Word("명령하다\n질서\n주문하다\n순서\n제도\n","order"));
		Data.add(new Word("나이든\n오래된\n노인\n늙은\n낡은\n","old"));
		Data.add(new Word("사무소\n회사\n직무\n의원\n공직\n","office"));
		Data.add(new Word("점\n지적하다\n포인트\n요점\n시점\n","point"));
		Data.add(new Word("통과하다\n지나가다\n사망하다\n패스\n통하다\n","pass"));
		Data.add(new Word("게임하다\n역할을하다\n연주하다\n경기\n배역을맡다\n","play"));
		Data.add(new Word("곳\n장소\n놓다\n지역\n공간\n","place"));
		Data.add(new Word("당기다\n끌다\n철수시키다\n뽑다\n빼다\n","pull"));
		Data.add(new Word("부분\n일부\n지역\n부품\n일환\n","part"));
		Data.add(new Word("추진하다\n밀다\n누르다\n노력하다\n압력을가하다\n","push"));
		Data.add(new Word("논문\n종이\n신문\n서류\n용지\n","paper"));
		Data.add(new Word("현재의\n보여주다\n선물하다\n제시하다\n발표하다\n","present"));
		Data.add(new Word("넣다\n두다\n쓰다\n붙이다\n간단히말하다\n","put"));
		Data.add(new Word("빠른\n빨리\n신속한\n급한\n민첩한\n","quick"));
		Data.add(new Word("조용히\n고요한\n침묵한\n평화로운\n차분한\n","quiet"));
		Data.add(new Word("질문\n문제\n의문\n묻다\n의심\n","question"));
		Data.add(new Word("꽤\n아주\n상당히\n상당수의\n완전히\n","quite"));
		Data.add(new Word("분기\n\n센트\n쿼터\n개월\n","quarter"));
		Data.add(new Word("품질\n질\n특성\n자질\n고급의\n","quality"));
		Data.add(new Word("양\n수량\n양적인\n다량\n","quantity"));
		Data.add(new Word("그만두다\n끊다\n포기하다\n떠나다\n관두다\n","quit"));
		Data.add(new Word("여왕\n퀸\n왕비\n왕후\n","queen"));
		Data.add(new Word("달리다\n운영하다\n출마\n열리다\n계속하다\n","run"));
		Data.add(new Word("권리\n인권\n옳은\n맞는\n바로\n","right"));
		Data.add(new Word("증가하다\n상승하다\n오르다\n늘다\n높아지다\n","rise"));
		Data.add(new Word("돌아오다\n복귀하다\n돌아가다\n돌려주다\n수익\n","return"));
		Data.add(new Word("나머지\n휴식\n쉬다\n안심\n죽다\n","rest"));
		Data.add(new Word("높이다\n올리다\n오르다\n인상\n제기하다\n","raise"));
		Data.add(new Word("타다\n달리다\n편승하다\n극복하다\n실어나르다\n","ride"));
		Data.add(new Word("읽다\n독서하다\n독해하다\n쓰여있다\n낭독하다\n","read"));
		Data.add(new Word("보고\n보고서\n보도\n발표하다\n알리다\n","report"));
		Data.add(new Word("도달하다\n이르다\n도착하다\n닿다\n손을뻗다\n","reach"));
		Data.add(new Word("세우다\n정해진\n세트\n설정하다\n놓다\n","set"));
		Data.add(new Word("그래서\n그렇게\n그렇다면\n그러니\n따라서\n","so"));
		Data.add(new Word("서비스\n봉사\n근무\n","service"));
		Data.add(new Word("파업하다\n공격하다\n타격\n치다\n스트라이크\n","strike"));
		Data.add(new Word("쏘다\n촬영하다\n사격하다\n슛\n발사하다\n","shoot"));
		Data.add(new Word("세우다\n서다\n서있다\n입장\n위치하다\n","stand"));
		Data.add(new Word("짧은\n단기의\n단편\n작은\n단거리\n","short"));
		Data.add(new Word("보다\n알다\n만나다\n발견하다\n이해하다\n","see"));
		Data.add(new Word("부드러운\n소프트한\n연한\n약한\n유연한\n","soft"));
		Data.add(new Word("시작하다\n처음\n출발하다\n출발점\n선발\n","start"));
		Data.add(new Word("되다\n돌리다\n바꾸다\n전환하다\n켜다\n","turn"));
		Data.add(new Word("시간이걸리다\n가지다\n받다\n찍다\n데려가다\n","take"));
		Data.add(new Word("위\n최고인\n가장\n상위\n정상\n","top"));
		Data.add(new Word("시간\n때\n시기\n동안\n당시\n","time"));
		Data.add(new Word("만지다\n터치\n감동시키다\n연락을하다\n접촉하다\n","touch"));
		Data.add(new Word("저것\n것\n그\n다른\n","that"));
		Data.add(new Word("에\n까지\n에대하여\n\n","to"));
		Data.add(new Word("생각하다\n같다\n상상하다\n평가하다\n예상하다\n","think"));
		Data.add(new Word("던지다\n버리다\n가하다\n넣다\n파티를열다\n","throw"));
		Data.add(new Word("훈련하다\n교육하다\n열차\n기차\n양성하다\n","train"));
		Data.add(new Word("위\n오르다\n증가하다\n늘리다\n일어나다\n","up"));
		Data.add(new Word("아래의\n밑에\n하에\n미만의\n지배하에\n","under"));
		Data.add(new Word("이용하다\n사용하다\n쓰다\n","use"));
		Data.add(new Word("이해하다\n알다\n깨닫다\n납득하다\n","understand"));
		Data.add(new Word("할때까지\n까지\n이되어비로소\n","until"));
		Data.add(new Word("유용한\n쓸모있는\n유익한\n도움이되는\n실용적인\n","useful"));
		Data.add(new Word("우리\n미국\n위에말한바와같이\n","us"));
		Data.add(new Word("사용된\n이용된\n익숙한\n예전에자주하다\n중고품의\n","used"));
		Data.add(new Word("위의\n상류의\n상위의\n","upper"));
		Data.add(new Word("평소의\n일반적인\n보통의\n늘\n","usual"));
		Data.add(new Word("매우\n아주\n정말\n굉장히\n가장\n","very"));
		Data.add(new Word("가치\n가치관\n평가\n가격\n중시하다\n","value"));
		Data.add(new Word("방문하다\n가다\n찾다\n오다\n체류하다\n","visit"));
		Data.add(new Word("목소리\n음성\n소리\n의견\n표현\n","voice"));
		Data.add(new Word("투표\n표\n선거\n표결\n","vote"));
		Data.add(new Word("보기\n견해\n관점\n전망\n관찰하다\n","view"));
		Data.add(new Word("다양\n여러종류\n여러가지\n버라이어티\n갖가지\n","variety"));
		Data.add(new Word("폭력\n범죄\n공격\n분쟁\n테러\n","violence"));
		Data.add(new Word("비디오\n영상\n녹화\n영화\n텔레비전\n","video"));
		Data.add(new Word("방학\n휴가\n","vacation"));
		Data.add(new Word("일하다\n연구\n작업\n작품\n작동하다\n","work"));
		Data.add(new Word("씻다\n세탁하다\n밀려오다\n닦다\n감다\n","wash"));
		Data.add(new Word("잘\n흠\n충분히\n나은\n우물\n","well"));
		Data.add(new Word("걷다\n보행\n산책하다\n","walk"));
		Data.add(new Word("바람\n풍력\n강풍\n불다\n","wind"));
		Data.add(new Word("의지\n할것이다\n유언\n","will"));
		Data.add(new Word("방법\n방식\n길\n방면\n점\n","way"));
		Data.add(new Word("물\n바다\n수분\n수역\n수면\n","water"));
		Data.add(new Word("함께\n때문에\n","with"));
		Data.add(new Word("무엇\n어떻게\n어떤\n뭐라고\n무슨\n","what"));
		Data.add(new Word("선\n엑스레이\n레이\n",""));
		Data.add(new Word("크리스마스\n","xmas"));
		Data.add(new Word("나무의뜻\n크실렌의\n","xylo"));
		Data.add(new Word("이종이식\n을이종이식하다\n이종이식장기\n","xenotransplant"));
		Data.add(new Word("말소하다\n없애다\n말살하다\n",""));
		Data.add(new Word("외인이종외부의뜻\n","xeno"));
		Data.add(new Word("황색크산토겐산의뜻\n","xantho"));
		Data.add(new Word("그리스알파벳제자\n\n시장강\n","xi"));
		Data.add(new Word("남자이름\n사비에\n자비에\n","xavier"));
		Data.add(new Word("젊은\n어린\n청년의\n새끼\n경험이없는\n","young"));
		Data.add(new Word("아직\n그러나\n하지만\n그런데도\n여전히\n","yet"));
		Data.add(new Word("수확\n항복\n수율\n수익\n수익률\n","yield"));
		Data.add(new Word("연도해\n나이\n학년\n연령\n","year"));
		Data.add(new Word("여러분\n당신\n너\n자네\n","you"));
		Data.add(new Word("그렇습니다\n네\n맞아\n그래\n예\n","yes"));
		Data.add(new Word("당신의것\n당신의\n네것\n","yours"));
		Data.add(new Word("여러분의\n당신의\n너의\n자네의\n","your"));
		Data.add(new Word("노란색\n노란\n황색\n황열병\n누런\n","yellow"));
		Data.add(new Word("어제\n최근\n과거\n작금\n바로얼마전에\n","yesterday"));
		Data.add(new Word("\n제로\n없음\n","zero"));
		Data.add(new Word("을지퍼로잠그다\n비밀로하다\n빨리나가다\n제로\n","zip"));
		Data.add(new Word("지역\n지대\n존\n지구\n구분하다\n","zone"));
		Data.add(new Word("열광적인\n과도한\n열심인\n","zealous"));
		Data.add(new Word("동물원\n","zoo"));
		Data.add(new Word("열의\n열기\n혈안\n","zeal"));
		Data.add(new Word("급상승\n줌렌즈\n폭음을내며급상승하다\n","zoom"));
		Data.add(new Word("얼룩말\n","zebra"));
